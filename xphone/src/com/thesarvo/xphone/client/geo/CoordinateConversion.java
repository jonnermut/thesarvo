package com.thesarvo.xphone.client.geo;
/*
...
public class CoordinateConversion
{
  ...
  public double[] utm2LatLon(int zone, String latZone, double x, double y)
  {
    UTM2LatLon c = new UTM2LatLon();
    return c.convertUTMToLatLong(zone, latZone, x, y);
  }
  ...
  public class UTM
  {
	...
	public UTM(String longZone, String latZone, double easting, double northing)
	{
		super();
	...
	/**
	 * @param longZone the longZone to set
	 */
	...
	/**
	 * @param latZone the latZone to set
	 */
	...
	public String toString()
	{
		...
		return longZone + " " + latZone + " " + ((int)easting) + " " + ((int) northing);
	}
  ...
  {
    public String convertLatLonToUTMString(double latitude, double longitude)
    {
    	return convertLatLonToUTM(latitude, longitude).toString();
    ...
    public UTM convertLatLonToUTM(double latitude, double longitude)
    {
        ...
        return new UTM(longZone, latZone, _easting, _northing);
    }
  ...
  private class UTM2LatLon
  {
    ...
    public double[] convertUTMToLatLong(int zone, String latZone, double x, double y)
    {
      double[] latlon = { 0.0, 0.0 };
...
//      System.out.println("e1:" + this.ei);
//      
//      System.out.println("ca:" + this.ca);
//      System.out.println("cb:" + this.cb);
//      System.out.println("cc:" + this.cc);
//      System.out.println("cd:" + this.cd);
//      
//      System.out.println("footprint lat phi1:" + this.phi1);
//      
//      
...
//      
//      System.out.println("_a1:" + this._a1);
//      System.out.println("k0:" + this.k0);
//      System.out.println("dd0:" + this.dd0);
//      
//      System.out.println("lof1:" + this.lof1);
//      System.out.println("lof2:" + this.lof2);
//      System.out.println("lof3:" + this.lof3);
//
//      
//      
//      System.out.println("Fact1:" + this.fact1);
//      System.out.println("Fact2:" + this.fact2);
//      System.out.println("Fact3:" + this.fact3);
//      System.out.println("Fact4:" + this.fact4);
      
      
      latitude = 180 * (phi1 - fact1 * (fact2 + fact3 + fact4)) / Math.PI;
      
      //latitude = phi1 * (180/Math.PI);
  ...
  {
    private Map digraph1 = new HashMap();

    private Map digraph2 = new HashMap();
