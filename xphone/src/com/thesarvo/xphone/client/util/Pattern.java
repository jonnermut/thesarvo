 ...
 * aroung the Javascript <a href="https://developer.mozilla.org/en/Core_JavaScript_1.5_Reference/Global_Objects/RegExp"
...
public class Pattern
{
	...
	public static JavaScriptObject createExpression(String pattern, int flags)
	{
		String sFlags = "";
	...
	private native void _match(String text, List matches) /*-{
		var regExp = this.@com.thesarvo.xphone.client.util.Pattern::regExp;
	 ...
	 *         array is returned.
	 */
	public String[] matchAsArray(String text)
	{
	 ...
	 * 
	 * @param text
	 * @return List of strings following java's Pattern convention for groups:
	 *         Group 0 is the entire input string and the remaining groups are
	 *         the matched parenthesis. In case nothing was matched an empty
	 *         array is returned.
	 */
