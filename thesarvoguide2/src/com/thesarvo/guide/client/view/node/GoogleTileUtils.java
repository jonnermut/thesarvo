...
//	/**
//	 * Returns the pixel offset of a latitude and longitude within a single
//	 * typical google tile.
//	 * 
//	 * @param lat
//	 * @param lng
...
//	}
	 ...
	 */
	public static double[] getTileRect(int x, int y, int zoom)
	{
		...
		double latHeightMerc = 1.0 / tilesAtThisZoom; // height in "normalized"
		...
		return new double[] {topLat, lng, bottomLat, lng + lngWidth};
	}

	/**
	 * returns the lat/lng as an "Offset Normalized Mercator" pixel coordinate,
	 * this is a coordinate that runs from 0..1 in latitude and longitude with
	 * 0,0 being top left. Normalizing means that this routine can be used at
	 * any zoom level and then multiplied by a power of two to get actual pixel
	 * coordinates.
	 * 
	 * @param lat
	 *            in degrees
...
//		// "pixel offset"
//		return new Point((int) (normalised.getX() * scale), (int) (normalised
//				.getY() * scale));
//	}
//
//	/**
...
//
//	/**
//	 * Returns a google maps satellite type string for the tile containing the
//	 * lat and lng at the zoom level.
//	 * 
//	 * @param lat
//	 * @param lng
//	 * @param zoom
...
//	{
//		// must start with "t"
//		if ((satelliteRef == null) || (satelliteRef.length() == 0)
//				|| (satelliteRef.charAt(0) != 't'))
//		{
...
//
//			default:
//				throw new RuntimeException("satellite char '" + c
//						+ "' when decoding keyhole string.");
//			}
//		}
//
...
//
//		// center
//		System.out.println("center, expect 0.5,0.5\t"
//				+ toNormalisedPixelCoords(0, 0));
//
//		// topleft
//		System.out.println("topLeft, expect 0,0\t"
//				+ toNormalisedPixelCoords(85.05113f, -180));
//
//		// topright
//		System.out.println("topRight, expect 1,0\t"
//				+ toNormalisedPixelCoords(85.05113f, 180 - eps));
//
//		// bottomleft
//		System.out.println("bottomLeft, expect 0,1\t"
//				+ toNormalisedPixelCoords(-85.05113f, -180));
//
//		// bottomright
//		System.out.println("bottomRight, expect 1,1\t"
//				+ toNormalisedPixelCoords(-85.05113f, 180 - eps));
//
//		// my old home
//		System.out.println("my old home, expect \t"
//				+ toNormalisedPixelCoords(53.427972089896805,
//						-2.2671961784362793));
//
//		System.out.println("getTileXY");
//		System.out.println("center zoom=17, expect 0,0\t" + toTileXY(0, 0, 17));
//		System.out.println("slightly up right of center zoom=16, expect 1,0\t"
//				+ toTileXY(eps, eps, 16));
//		System.out.println("slightly up right of center zoom=15, expect 2,1\t"
//				+ toTileXY(eps, eps, 15));
...
//		System.out.println("center zoom=17, expect 127,127\t"
//				+ toZoomedPixelCoords(0, 0, 17));
//		System.out
//				.println("slightly up right of center zoom=16, expect 256,256\t"
//						+ toZoomedPixelCoords(eps, eps, 16));
//		System.out
//				.println("slightly up right of center zoom=15, expect 512,512\t"
//						+ toZoomedPixelCoords(eps, eps, 15));
//		System.out.println("my old home zoom=0, expect 16565898,10863803\t"
//				+ toZoomedPixelCoords(53.427972089896805, -2.2671961784362793,
//						0));
//
//		System.out.println("getPixelOffsetInTile");
//		System.out.println("center zoom=17, expect 127,127\t"
//				+ getPixelOffsetInTile(0, 0, 17));
//		System.out.println("slightly up right of center zoom=16, expect 0,0\t"
//				+ getPixelOffsetInTile(eps, eps, 16));
//		System.out.println("slightly up right of center zoom=15, expect 0,0\t"
//				+ getPixelOffsetInTile(eps, eps, 15));
//		System.out.println("my old home zoom=0, expect 138,187\t"
//				+ getPixelOffsetInTile(53.427972089896805, -2.2671961784362793,
//						0));
//
//		System.out.println("getSatelliteRef");
//		System.out.println("center zoom=17, expect t\t"
//				+ getSatelliteRef(0, 0, 17));
//		System.out.println("slightly up right of center zoom=16, expect tr\t"
//				+ getSatelliteRef(eps, eps, 16));
//		System.out.println("slightly up right of center zoom=15, expect trt\t"
//				+ getSatelliteRef(eps, eps, 15));
...
//				+ satelliteRefToZoom("tqsrsrrsqtssqqqsrq"));
//
...
//		System.out.println("expect 64710,42436\t"
//				+ satelliteRefToTileXY("tqsrsrrsqtssqqqsrq"));
//
...
//		System.out.println("expect -2.268677,53.42754, 0.002747,0.00163\t"
//				+ getTileRect(64710, 42436, 0));
//	}
