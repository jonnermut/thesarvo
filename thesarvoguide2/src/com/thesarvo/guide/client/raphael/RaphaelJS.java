  ...
  public static class Element extends JavaScriptObject {
    ...
    public final native Element animate(JavaScriptObject newAttrs, int ms, AnimationCallback callback) /*-{
      return this.animate(newAttrs, ms, function() {
        callback.@com.thesarvo.guide.client.raphael.AnimationCallback::onComplete()();
      });
    }-*/;
    ...
    public final native void drag(DragCallback callback) /*-{
      var start = function (x, y) {
        callback.@com.thesarvo.guide.client.raphael.DragCallback::onStart(DD)(x,y);
      },
      move = function (dx, dy, x, y) {
        callback.@com.thesarvo.guide.client.raphael.DragCallback::onMove(DDDD)(dx,dy,x,y);
      },
      up = function () {
        callback.@com.thesarvo.guide.client.raphael.DragCallback::onEnd()();
      };
	...
	public final native void click(ClickCallback callback) /*-{
		var func = function(e) {
			callback.@com.thesarvo.guide.client.raphael.ClickCallback::onClick(Lcom/google/gwt/user/client/Event;)(e);
		}
		this.click(func);
		
	}-*/;
    
	public final native void dblclick(DblClickCallback callback) /*-{
	
		var func = function(e) {
			callback.@com.thesarvo.guide.client.raphael.DblClickCallback::onDblClick()();
		}
		this.dblclick(func);
	...
	public final native com.thesarvo.guide.client.raphael.RaphaelJS.Element glow(
			String color, int width) /*-{
		return this.glow({'color':color, 'width':width});
	}-*/;
