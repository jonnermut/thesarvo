...
public class Raphael extends Widget {
  ...
  public class Shape extends Widget {
    ...
    public Shape animate(JavaScriptObject newAttrs, int duration) {
        el.animate(newAttrs, duration);
        return this;
    }
    ...
    public Shape attr(JavaScriptObject params) {
        el.attr(params);
        return this;
      }
    ...
    public void mouseover(MouseoverCallback callback) {
        el.mouseover(callback);
      }
    
    public void dblclick(DblClickCallback callback) {
	...
	public RaphaelJS.Element glow(String color, int width) {
		return el.glow(color, width);
